...
import { getPusherClient } from "@/infrastructure/pusher/client"; // Infrastructure WebSocket client instance
    ...
    <DropdownMenu.Root open={open} onOpenChange={setOpen}>
      ...
      <DropdownMenu.Portal>
        <DropdownMenu.Content
          align="end"
          sideOffset={6}
          className="w-80 max-h-[70vh] bg-white border border-slate-200 shadow-xl rounded-lg overflow-hidden z-[100] outline-none flex flex-col animate-in fade-in zoom-in-95 duration-150"
