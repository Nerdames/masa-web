  ...
  return (
    <DropdownMenu.Root open={open} onOpenChange={setOpen}>
      <DropdownMenu.Trigger asChild>
        <button className="relative w-10 h-10 flex items-center justify-center rounded-xl hover:bg-slate-100 transition-all outline-none group">
  ...
  return (
    ...
    >
      <div className="flex gap-4">
        <div className={`w-9 h-9 shrink-0 rounded-xl ${config.bg} flex items-center justify-center text-white shadow-sm`}>
