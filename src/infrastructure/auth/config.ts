...
import prisma from "@/infrastructure/prisma/client"; // Singleton pattern client destination
import { ROLE_PERMISSIONS_MATRIX } from "@/server/permissions/enforcer";
import { getCachedPermissions, setCachedPermissions } from "@/server/permissions/cache";
import { createAuditLog } from "@/modules/audit/server/audit.service";
import {
  Role,
  Severity,
  ActorType
