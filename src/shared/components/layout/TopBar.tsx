...
import { NotificationsBell } from "@/modules/notifications/components/NotificationsBell"; // Standardized notification hook wrapper
import { getInitials } from "@/shared/utils/string"; // Specific string utility path
import { cn } from "@/shared/utils"; // Main barrel-export index utility path
