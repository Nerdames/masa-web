...
const TILES: DashboardTile[] = [
  ...
  { id: "proc", title: "Procurement", descriptionSm: "Create POs & track receipts.", icon: ShoppingCart, href: "/inventory/procurement", color: "from-orange-500 to-amber-400", roles: [Role.ADMIN, Role.MANAGER, Role.INVENTORY, Role.DEV] },
