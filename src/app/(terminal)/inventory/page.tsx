...
const TILES: DashboardTile[] = [
  { id: "inv", title: "Inventory", descriptionSm: "Stock levels & safety stock.", icon: Box, href: "/terminal/inventory", color: "from-blue-600 to-cyan-500", roles: [Role.ADMIN, Role.MANAGER, Role.INVENTORY, Role.AUDITOR, Role.DEV] },
  { id: "po", title: "Purchase Orders", descriptionSm: "Create POs & track receipts.", icon: ShoppingCart, href: "/terminal/purchase-orders", color: "from-emerald-600 to-teal-500", roles: [Role.ADMIN, Role.MANAGER, Role.INVENTORY, Role.DEV] },
  ...
  { id: "app", title: "Approvals", descriptionSm: "Price updates & adjustments.", icon: ClipboardCheck, href: "/terminal/approvals", color: "from-purple-600 to-indigo-500", roles: [Role.ADMIN, Role.MANAGER, Role.DEV] },
  ...
  { id: "trn", title: "Transfers", descriptionSm: "Inter-branch movements.", icon: ArrowUpRight, href: "/terminal/transfers", color: "from-sky-600 to-indigo-500", roles: [Role.ADMIN, Role.MANAGER, Role.INVENTORY, Role.DEV] },
